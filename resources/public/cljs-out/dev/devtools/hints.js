...
}catch (e24599){var _e = e24599;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___24602 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___24602)){
var seen_errors_24603 = temp__5455__auto___24602;
if(cljs.core.truth_(seen_errors_24603.has(self))){
} else {
seen_errors_24603.add(self);

var temp__5457__auto___24604 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___24604)){
var sense_24605 = temp__5457__auto___24604;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_24605)].join('');
} else {
}
}
} else {
