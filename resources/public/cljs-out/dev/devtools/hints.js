...
}catch (e24838){var _e = e24838;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___24841 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___24841)){
var seen_errors_24842 = temp__5455__auto___24841;
if(cljs.core.truth_(seen_errors_24842.has(self))){
} else {
seen_errors_24842.add(self);

var temp__5457__auto___24843 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___24843)){
var sense_24844 = temp__5457__auto___24843;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_24844)].join('');
} else {
}
}
} else {
