...
var map__20029 = top_item;
var map__20029__$1 = ((((!((map__20029 == null)))?(((((map__20029.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20029.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20029):map__20029);
...
}catch (e20028){var _e = e20028;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___20031 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___20031)){
var seen_errors_20032 = temp__5455__auto___20031;
if(cljs.core.truth_(seen_errors_20032.has(self))){
} else {
seen_errors_20032.add(self);

var temp__5457__auto___20033 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___20033)){
var sense_20034 = temp__5457__auto___20033;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20034)].join('');
} else {
}
}
} else {
