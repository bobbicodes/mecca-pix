...
var G__15576 = devtools.prefs.pref.call(null,v);
v = G__15576;
continue;
} else {
return v;
...
}catch (e15579){var _e__14830__auto__ = e15579;
return false;
}})();
...
}catch (e15583){var _e__14830__auto__ = e15583;
return false;
}})();
...
}catch (e15585){var _e__14830__auto__ = e15585;
return false;
}}
}
});
...
var vec__15587 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__15587,(0),null);
var name = cljs.core.nth.call(null,vec__15587,(1),null);
...
return cljs.core.some.call(null,(function (p1__15590_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__15590_SHARP_);
}),template);
});
