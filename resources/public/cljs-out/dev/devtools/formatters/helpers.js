...
var G__15695 = devtools.prefs.pref.call(null,v);
v = G__15695;
continue;
} else {
return v;
...
}catch (e15698){var _e__14949__auto__ = e15698;
return false;
}})();
...
}catch (e15702){var _e__14949__auto__ = e15702;
return false;
}})();
...
}catch (e15704){var _e__14949__auto__ = e15704;
return false;
}}
}
});
...
var vec__15706 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__15706,(0),null);
var name = cljs.core.nth.call(null,vec__15706,(1),null);
...
return cljs.core.some.call(null,(function (p1__15709_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__15709_SHARP_);
}),template);
});
