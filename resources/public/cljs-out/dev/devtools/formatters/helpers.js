...
var G__26100 = devtools.prefs.pref.call(null,v);
v = G__26100;
continue;
} else {
return v;
...
}catch (e26103){var _e__24646__auto__ = e26103;
return false;
}})();
...
}catch (e26107){var _e__24646__auto__ = e26107;
return false;
}})();
...
}catch (e26109){var _e__24646__auto__ = e26109;
return false;
}}
}
});
...
var vec__26111 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__26111,(0),null);
var name = cljs.core.nth.call(null,vec__26111,(1),null);
...
return cljs.core.some.call(null,(function (p1__26114_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__26114_SHARP_);
}),template);
});
