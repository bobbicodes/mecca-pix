...
var G__15684 = devtools.prefs.pref.call(null,v);
v = G__15684;
continue;
} else {
return v;
...
}catch (e15687){var _e__14938__auto__ = e15687;
return false;
}})();
...
}catch (e15691){var _e__14938__auto__ = e15691;
return false;
}})();
...
}catch (e15693){var _e__14938__auto__ = e15693;
return false;
}}
}
});
...
var vec__15695 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
...
return cljs.core.some.call(null,(function (p1__15698_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__15698_SHARP_);
}),template);
});
