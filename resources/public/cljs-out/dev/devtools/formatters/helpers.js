...
var G__20513 = devtools.prefs.pref.call(null,v);
v = G__20513;
continue;
} else {
return v;
...
}catch (e20516){var _e__19767__auto__ = e20516;
return false;
}})();
...
}catch (e20520){var _e__19767__auto__ = e20520;
return false;
}})();
...
}catch (e20522){var _e__19767__auto__ = e20522;
return false;
}}
}
});
...
var vec__20524 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__20524,(0),null);
var name = cljs.core.nth.call(null,vec__20524,(1),null);
...
return cljs.core.some.call(null,(function (p1__20527_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__20527_SHARP_);
}),template);
});
