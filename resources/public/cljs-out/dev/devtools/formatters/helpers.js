...
var G__21868 = devtools.prefs.pref.call(null,v);
v = G__21868;
continue;
} else {
return v;
...
}catch (e21871){var _e__20685__auto__ = e21871;
return false;
}})();
...
}catch (e21875){var _e__20685__auto__ = e21875;
return false;
}})();
...
}catch (e21877){var _e__20685__auto__ = e21877;
return false;
}}
}
});
...
var vec__21879 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__21879,(0),null);
var name = cljs.core.nth.call(null,vec__21879,(1),null);
...
return cljs.core.some.call(null,(function (p1__21882_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21882_SHARP_);
}),template);
});
