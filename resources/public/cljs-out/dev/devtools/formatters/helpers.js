...
var G__15717 = devtools.prefs.pref.call(null,v);
v = G__15717;
continue;
} else {
return v;
...
}catch (e15720){var _e__14971__auto__ = e15720;
return false;
}})();
...
}catch (e15724){var _e__14971__auto__ = e15724;
return false;
}})();
...
}catch (e15726){var _e__14971__auto__ = e15726;
return false;
}}
}
});
...
var vec__15728 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__15728,(0),null);
var name = cljs.core.nth.call(null,vec__15728,(1),null);
...
return cljs.core.some.call(null,(function (p1__15731_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__15731_SHARP_);
}),template);
});
