...
var G__21427 = devtools.prefs.pref.call(null,v);
v = G__21427;
continue;
} else {
return v;
...
}catch (e21430){var _e__20681__auto__ = e21430;
return false;
}})();
...
}catch (e21434){var _e__20681__auto__ = e21434;
return false;
}})();
...
}catch (e21436){var _e__20681__auto__ = e21436;
return false;
}}
}
});
...
var vec__21438 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__21438,(0),null);
var name = cljs.core.nth.call(null,vec__21438,(1),null);
...
return cljs.core.some.call(null,(function (p1__21441_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21441_SHARP_);
}),template);
});
