...
var len__4531__auto___15730 = arguments.length;
var i__4532__auto___15731 = (0);
while(true){
if((i__4532__auto___15731 < len__4531__auto___15730)){
args__4534__auto__.push((arguments[i__4532__auto___15731]));

var G__15732 = (i__4532__auto___15731 + (1));
i__4532__auto___15731 = G__15732;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq15727){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15728,G__15729,seq15727__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__15733_SHARP_){
return !((cljs.core.meta.call(null,p1__15733_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__15734__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e15738){var _e__14938__auto__ = e15738;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e15740){var _e__14938__auto__ = e15740;
return false;
}}
})())){
...
var _STAR_current_state_STAR_15742 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__15743 = opts;
...
var markup_db = cljs.core.get.call(null,map__15743__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_15742;
}});
...
;
var temp__5455__auto___15747 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___15747)){
var managed_print_level_15748 = temp__5455__auto___15747;
var _STAR_print_level_STAR_15746_15749 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_15748;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_15746_15749,managed_print_level_15748,temp__5455__auto___15747,writer,opts,job_fn){
return (function (p1__15745_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__15745_SHARP_,null);
});})(_STAR_print_level_STAR_15746_15749,managed_print_level_15748,temp__5455__auto___15747,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_15746_15749;
}} else {
job_fn.call(null);
}
