...
var len__4531__auto___20324 = arguments.length;
var i__4532__auto___20325 = (0);
while(true){
if((i__4532__auto___20325 < len__4531__auto___20324)){
args__4534__auto__.push((arguments[i__4532__auto___20325]));

var G__20326 = (i__4532__auto___20325 + (1));
i__4532__auto___20325 = G__20326;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq20321){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20322,G__20323,seq20321__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__20327_SHARP_){
return !((cljs.core.meta.call(null,p1__20327_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__20328__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e20332){var _e__19532__auto__ = e20332;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e20334){var _e__19532__auto__ = e20334;
return false;
}}
})())){
...
var _STAR_current_state_STAR_20336 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__20337 = opts;
...
var markup_db = cljs.core.get.call(null,map__20337__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_20336;
}});
...
;
var temp__5455__auto___20341 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___20341)){
var managed_print_level_20342 = temp__5455__auto___20341;
var _STAR_print_level_STAR_20340_20343 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_20342;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_20340_20343,managed_print_level_20342,temp__5455__auto___20341,writer,opts,job_fn){
return (function (p1__20339_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__20339_SHARP_,null);
});})(_STAR_print_level_STAR_20340_20343,managed_print_level_20342,temp__5455__auto___20341,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_20340_20343;
}} else {
job_fn.call(null);
}
