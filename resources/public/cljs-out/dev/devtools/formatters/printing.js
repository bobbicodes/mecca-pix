...
var len__4531__auto___20329 = arguments.length;
var i__4532__auto___20330 = (0);
while(true){
if((i__4532__auto___20330 < len__4531__auto___20329)){
args__4534__auto__.push((arguments[i__4532__auto___20330]));

var G__20331 = (i__4532__auto___20330 + (1));
i__4532__auto___20330 = G__20331;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq20326){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20327,G__20328,seq20326__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__20332_SHARP_){
return !((cljs.core.meta.call(null,p1__20332_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__20333__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e20337){var _e__19537__auto__ = e20337;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e20339){var _e__19537__auto__ = e20339;
return false;
}}
})())){
...
var _STAR_current_state_STAR_20341 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__20342 = opts;
var map__20342__$1 = ((((!((map__20342 == null)))?(((((map__20342.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20342.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20342):map__20342);
var markup_db = cljs.core.get.call(null,map__20342__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_20341;
}});
...
;
var temp__5455__auto___20346 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___20346)){
var managed_print_level_20347 = temp__5455__auto___20346;
var _STAR_print_level_STAR_20345_20348 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_20347;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_20345_20348,managed_print_level_20347,temp__5455__auto___20346,writer,opts,job_fn){
return (function (p1__20344_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__20344_SHARP_,null);
});})(_STAR_print_level_STAR_20345_20348,managed_print_level_20347,temp__5455__auto___20346,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_20345_20348;
}} else {
job_fn.call(null);
}
