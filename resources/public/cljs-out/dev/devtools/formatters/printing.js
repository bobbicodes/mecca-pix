...
var len__4531__auto___20325 = arguments.length;
var i__4532__auto___20326 = (0);
while(true){
if((i__4532__auto___20326 < len__4531__auto___20325)){
args__4534__auto__.push((arguments[i__4532__auto___20326]));

var G__20327 = (i__4532__auto___20326 + (1));
i__4532__auto___20326 = G__20327;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq20322){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20323,G__20324,seq20322__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__20328_SHARP_){
return !((cljs.core.meta.call(null,p1__20328_SHARP_) == null));
})))){
...
var map__20329 = opts;
var map__20329__$1 = ((((!((map__20329 == null)))?(((((map__20329.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20329.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20329):map__20329);
var markup_db = cljs.core.get.call(null,map__20329__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e20333){var _e__19533__auto__ = e20333;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e20335){var _e__19533__auto__ = e20335;
return false;
}}
})())){
...
var _STAR_current_state_STAR_20337 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__20338 = opts;
...
var markup_db = cljs.core.get.call(null,map__20338__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_20337;
}});
...
;
var temp__5455__auto___20342 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___20342)){
var managed_print_level_20343 = temp__5455__auto___20342;
var _STAR_print_level_STAR_20341_20344 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_20343;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_20341_20344,managed_print_level_20343,temp__5455__auto___20342,writer,opts,job_fn){
return (function (p1__20340_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__20340_SHARP_,null);
});})(_STAR_print_level_STAR_20341_20344,managed_print_level_20343,temp__5455__auto___20342,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_20341_20344;
}} else {
job_fn.call(null);
}
