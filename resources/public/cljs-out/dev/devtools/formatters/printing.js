...
var len__4531__auto___15726 = arguments.length;
var i__4532__auto___15727 = (0);
while(true){
if((i__4532__auto___15727 < len__4531__auto___15726)){
args__4534__auto__.push((arguments[i__4532__auto___15727]));

var G__15728 = (i__4532__auto___15727 + (1));
i__4532__auto___15727 = G__15728;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq15723){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15724,G__15725,seq15723__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__15729_SHARP_){
return !((cljs.core.meta.call(null,p1__15729_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__15730__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e15734){var _e__14934__auto__ = e15734;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e15736){var _e__14934__auto__ = e15736;
return false;
}}
})())){
...
var _STAR_current_state_STAR_15738 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__15739 = opts;
var map__15739__$1 = ((((!((map__15739 == null)))?(((((map__15739.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15739.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15739):map__15739);
var markup_db = cljs.core.get.call(null,map__15739__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_15738;
}});
...
;
var temp__5455__auto___15743 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___15743)){
var managed_print_level_15744 = temp__5455__auto___15743;
var _STAR_print_level_STAR_15742_15745 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_15744;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_15742_15745,managed_print_level_15744,temp__5455__auto___15743,writer,opts,job_fn){
return (function (p1__15741_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__15741_SHARP_,null);
});})(_STAR_print_level_STAR_15742_15745,managed_print_level_15744,temp__5455__auto___15743,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_15742_15745;
}} else {
job_fn.call(null);
}
