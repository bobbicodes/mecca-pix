...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq26143){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__26149_SHARP_){
return !((cljs.core.meta.call(null,p1__26149_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__26150__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e26154){var _e__24646__auto__ = e26154;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e26156){var _e__24646__auto__ = e26156;
return false;
}}
})())){
...
var _STAR_current_state_STAR_26158 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__26159 = opts;
...
var markup_db = cljs.core.get.call(null,map__26159__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_26158;
}});
...
;
var temp__5455__auto___26163 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___26163)){
var managed_print_level_26164 = temp__5455__auto___26163;
var _STAR_print_level_STAR_26162_26165 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_26164;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_26162_26165,managed_print_level_26164,temp__5455__auto___26163,writer,opts,job_fn){
return (function (p1__26161_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__26161_SHARP_,null);
});})(_STAR_print_level_STAR_26162_26165,managed_print_level_26164,temp__5455__auto___26163,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_26162_26165;
}} else {
job_fn.call(null);
}
