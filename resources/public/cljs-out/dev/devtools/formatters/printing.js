...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq15607){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15608,G__15609,seq15607__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__15613_SHARP_){
return !((cljs.core.meta.call(null,p1__15613_SHARP_) == null));
})))){
...
var map__15614 = opts;
var map__15614__$1 = ((((!((map__15614 == null)))?(((((map__15614.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15614.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15614):map__15614);
var markup_db = cljs.core.get.call(null,map__15614__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e15618){var _e__14818__auto__ = e15618;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e15620){var _e__14818__auto__ = e15620;
return false;
}}
})())){
...
var _STAR_current_state_STAR_15622 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__15623 = opts;
...
var markup_db = cljs.core.get.call(null,map__15623__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_15622;
}});
...
;
var temp__5455__auto___15627 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___15627)){
var managed_print_level_15628 = temp__5455__auto___15627;
var _STAR_print_level_STAR_15626_15629 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_15628;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_15626_15629,managed_print_level_15628,temp__5455__auto___15627,writer,opts,job_fn){
return (function (p1__15625_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__15625_SHARP_,null);
});})(_STAR_print_level_STAR_15626_15629,managed_print_level_15628,temp__5455__auto___15627,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_15626_15629;
}} else {
job_fn.call(null);
}
