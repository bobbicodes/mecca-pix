...
var o14980 = temp__5455__auto__;
var temp__5455__auto____$1 = (o14980["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o14981 = temp__5455__auto____$1;
return (o14981["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__14800__auto__ = f;
return (o__14800__auto__["toString"]).call(o__14800__auto__);
} else {
return "";
}
}catch (e14982){var _ = e14982;
return "";
}});
...
try{var o__14800__auto___14984 = t;
(o__14800__auto___14984["cljs$lang$ctorPrWriter"]).call(o__14800__auto___14984,t,writer);
}catch (e14983){var __14985 = e14983;
}
...
var char_code = (function (){var o__14800__auto__ = (new String(char$));
return (o__14800__auto__["charCodeAt"]).call(o__14800__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__14800__auto__ = String;
return (o__14800__auto__["fromCharCode"]).call(o__14800__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__14986 = num_code;
switch (G__14986) {
case (1):
return (185);
...
var o__14800__auto__ = String;
return (o__14800__auto__["fromCharCode"]).call(o__14800__auto__,superscript_code);
});
/**
...
}catch (e14988){var _e__14807__auto__ = e14988;
return false;
}})())){
...
var vec__14989 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__14989,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o14992 = temp__5455__auto__;
var temp__5455__auto____$1 = (o14992["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o14993 = temp__5455__auto____$1;
return (o14993["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__14996){
var vec__14997 = p__14996;
var ns_detector = cljs.core.nth.call(null,vec__14997,(0),null);
...
var G__15003 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__15004 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__15003;
remaining_tokens = G__15004;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq14994){
var G__14995 = cljs.core.first.call(null,seq14994);
var seq14994__$1 = cljs.core.next.call(null,seq14994);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14995,seq14994__$1);
});
...
var vec__15008 = cljs.core.split_with.call(null,(function (p1__15007_SHARP_){
return cljs.core.not_EQ_.call(null,p1__15007_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__15008,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__15008,(1),null);
...
var vec__15011 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__15011,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__15011,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__15014 = cljs.core.rest.call(null,remaining_tokens);
var G__15015 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__15014;
name_tokens = G__15015;
continue;
} else {
...
var vec__15018 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__15018,(0),null);
var arity = cljs.core.nth.call(null,vec__15018,(1),null);
var vec__15021 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__15021,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__15021,(1),null);
var vec__15024 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__15024,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__15024,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__15024,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__15024,(3),null);
...
var vec__15030 = result;
var munged_ns = cljs.core.nth.call(null,vec__15030,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__15030,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__15030,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__15030,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__15030,(4),null);
var arity = cljs.core.nth.call(null,vec__15030,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__15034 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__15034,(0),null);
var args = cljs.core.nth.call(null,vec__15034,(1),null);
var vec__15037 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__15037,(0),null);
var name = cljs.core.nth.call(null,vec__15037,(1),null);
...
var G__15040 = (arity + (1));
var G__15041 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
var arity = cljs.core.nth.call(null,vec__15043,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__15043,(1),null);
...
return cljs.core.get.call(null,arities,p1__15046_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__15047_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___15054 = arguments.length;
var i__4532__auto___15055 = (0);
while(true){
if((i__4532__auto___15055 < len__4531__auto___15054)){
args__4534__auto__.push((arguments[i__4532__auto___15055]));

var G__15056 = (i__4532__auto___15055 + (1));
i__4532__auto___15055 = G__15056;
continue;
} else {
}
break;
...
var humanize_QMARK_ = cljs.core.nth.call(null,vec__15051,(0),null);
...
var G__15057 = arg;
var G__15057__$1 = (((G__15057 instanceof cljs.core.Keyword))?G__15057.fqn:null);
switch (G__15057__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__15059__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__15059__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__15059__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__15059__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__15060 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__15060,(0),null);
var fn_name = cljs.core.nth.call(null,vec__15060,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__15060,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__15060,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__15060,(4),null);
var arity = cljs.core.nth.call(null,vec__15060,(5),null);
...
var o__14800__auto__ = f;
return (o__14800__auto__["getBasis"]).call(o__14800__auto__);
});
/**
...
}catch (e15064){var _e__14807__auto__ = e15064;
...
var G__15065 = (obj[cljs.core.first.call(null,path)]);
var G__15066 = cljs.core.rest.call(null,path);
obj = G__15065;
path = G__15066;
continue;
} else {
...
return (function (accum,p__15067){
var vec__15068 = p__15067;
var bit = cljs.core.nth.call(null,vec__15068,(0),null);
var protocol = cljs.core.nth.call(null,vec__15068,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__15071){
var vec__15072 = p__15071;
var ns = cljs.core.nth.call(null,vec__15072,(0),null);
var name = cljs.core.nth.call(null,vec__15072,(1),null);
var selector = cljs.core.nth.call(null,vec__15072,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__15077,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__15077,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__15077,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__15075_SHARP_){
return (obj[cljs.core.first.call(null,p1__15075_SHARP_)]);
});})(name,sorted_matches,vec__15077,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
