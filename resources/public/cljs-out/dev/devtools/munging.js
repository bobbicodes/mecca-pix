...
var o15144 = temp__5455__auto__;
var temp__5455__auto____$1 = (o15144["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o15145 = temp__5455__auto____$1;
return (o15145["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__14964__auto__ = f;
return (o__14964__auto__["toString"]).call(o__14964__auto__);
} else {
return "";
}
}catch (e15146){var _ = e15146;
return "";
}});
...
try{var o__14964__auto___15148 = t;
(o__14964__auto___15148["cljs$lang$ctorPrWriter"]).call(o__14964__auto___15148,t,writer);
}catch (e15147){var __15149 = e15147;
}
...
var char_code = (function (){var o__14964__auto__ = (new String(char$));
return (o__14964__auto__["charCodeAt"]).call(o__14964__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__14964__auto__ = String;
return (o__14964__auto__["fromCharCode"]).call(o__14964__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__15150 = num_code;
switch (G__15150) {
case (1):
return (185);
...
var o__14964__auto__ = String;
return (o__14964__auto__["fromCharCode"]).call(o__14964__auto__,superscript_code);
});
/**
...
}catch (e15152){var _e__14971__auto__ = e15152;
return false;
}})())){
...
var vec__15153 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__15153,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o15156 = temp__5455__auto__;
var temp__5455__auto____$1 = (o15156["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o15157 = temp__5455__auto____$1;
return (o15157["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___15164 = arguments.length;
var i__4532__auto___15165 = (0);
while(true){
if((i__4532__auto___15165 < len__4531__auto___15164)){
args__4534__auto__.push((arguments[i__4532__auto___15165]));

var G__15166 = (i__4532__auto___15165 + (1));
i__4532__auto___15165 = G__15166;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__15160){
var vec__15161 = p__15160;
var ns_detector = cljs.core.nth.call(null,vec__15161,(0),null);
...
var G__15167 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__15168 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__15167;
remaining_tokens = G__15168;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq15158){
var G__15159 = cljs.core.first.call(null,seq15158);
var seq15158__$1 = cljs.core.next.call(null,seq15158);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15159,seq15158__$1);
});
...
var vec__15172 = cljs.core.split_with.call(null,(function (p1__15171_SHARP_){
return cljs.core.not_EQ_.call(null,p1__15171_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__15172,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__15172,(1),null);
...
var vec__15175 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__15175,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__15175,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__15178 = cljs.core.rest.call(null,remaining_tokens);
var G__15179 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__15178;
name_tokens = G__15179;
continue;
} else {
...
var vec__15182 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__15182,(0),null);
var arity = cljs.core.nth.call(null,vec__15182,(1),null);
var vec__15185 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__15185,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__15185,(1),null);
var vec__15188 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__15188,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__15188,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__15188,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__15188,(3),null);
...
var vec__15194 = result;
var munged_ns = cljs.core.nth.call(null,vec__15194,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__15194,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__15194,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__15194,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__15194,(4),null);
var arity = cljs.core.nth.call(null,vec__15194,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__15198 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__15198,(0),null);
var args = cljs.core.nth.call(null,vec__15198,(1),null);
var vec__15201 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__15201,(0),null);
var name = cljs.core.nth.call(null,vec__15201,(1),null);
...
var G__15204 = (arity + (1));
var G__15205 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__15206){
var vec__15207 = p__15206;
var arity = cljs.core.nth.call(null,vec__15207,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__15207,(1),null);
...
return cljs.core.get.call(null,arities,p1__15210_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__15211_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___15218 = arguments.length;
var i__4532__auto___15219 = (0);
while(true){
if((i__4532__auto___15219 < len__4531__auto___15218)){
args__4534__auto__.push((arguments[i__4532__auto___15219]));

var G__15220 = (i__4532__auto___15219 + (1));
i__4532__auto___15219 = G__15220;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__15214){
var vec__15215 = p__15214;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__15215,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq15212){
var G__15213 = cljs.core.first.call(null,seq15212);
var seq15212__$1 = cljs.core.next.call(null,seq15212);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15213,seq15212__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__15223__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__15223__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__15223__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__15223__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__15224 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__15224,(0),null);
var fn_name = cljs.core.nth.call(null,vec__15224,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__15224,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__15224,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__15224,(4),null);
var arity = cljs.core.nth.call(null,vec__15224,(5),null);
...
var o__14964__auto__ = f;
return (o__14964__auto__["getBasis"]).call(o__14964__auto__);
});
/**
...
}catch (e15228){var _e__14971__auto__ = e15228;
...
var G__15229 = (obj[cljs.core.first.call(null,path)]);
var G__15230 = cljs.core.rest.call(null,path);
obj = G__15229;
path = G__15230;
continue;
} else {
...
return (function (accum,p__15231){
var vec__15232 = p__15231;
var bit = cljs.core.nth.call(null,vec__15232,(0),null);
var protocol = cljs.core.nth.call(null,vec__15232,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__15235){
var vec__15236 = p__15235;
var ns = cljs.core.nth.call(null,vec__15236,(0),null);
var name = cljs.core.nth.call(null,vec__15236,(1),null);
var selector = cljs.core.nth.call(null,vec__15236,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__15241,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__15241,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__15241,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__15239_SHARP_){
return (obj[cljs.core.first.call(null,p1__15239_SHARP_)]);
});})(name,sorted_matches,vec__15241,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
