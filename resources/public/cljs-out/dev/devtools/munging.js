...
var temp__5455__auto____$1 = (o15003["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o15004 = temp__5455__auto____$1;
return (o15004["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__14823__auto__ = f;
return (o__14823__auto__["toString"]).call(o__14823__auto__);
} else {
return "";
}
}catch (e15005){var _ = e15005;
return "";
}});
...
try{var o__14823__auto___15007 = t;
(o__14823__auto___15007["cljs$lang$ctorPrWriter"]).call(o__14823__auto___15007,t,writer);
}catch (e15006){var __15008 = e15006;
}
...
var char_code = (function (){var o__14823__auto__ = (new String(char$));
return (o__14823__auto__["charCodeAt"]).call(o__14823__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__14823__auto__ = String;
return (o__14823__auto__["fromCharCode"]).call(o__14823__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__15009 = num_code;
switch (G__15009) {
case (1):
return (185);
...
var o__14823__auto__ = String;
return (o__14823__auto__["fromCharCode"]).call(o__14823__auto__,superscript_code);
});
/**
...
}catch (e15011){var _e__14830__auto__ = e15011;
return false;
}})())){
...
var vec__15012 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__15012,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o15015 = temp__5455__auto__;
var temp__5455__auto____$1 = (o15015["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o15016 = temp__5455__auto____$1;
return (o15016["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__15019){
var vec__15020 = p__15019;
var ns_detector = cljs.core.nth.call(null,vec__15020,(0),null);
...
var G__15026 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__15027 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__15026;
remaining_tokens = G__15027;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq15017){
var G__15018 = cljs.core.first.call(null,seq15017);
var seq15017__$1 = cljs.core.next.call(null,seq15017);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15018,seq15017__$1);
});
...
var vec__15031 = cljs.core.split_with.call(null,(function (p1__15030_SHARP_){
return cljs.core.not_EQ_.call(null,p1__15030_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__15031,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__15031,(1),null);
...
var vec__15034 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__15034,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__15034,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__15037 = cljs.core.rest.call(null,remaining_tokens);
var G__15038 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__15037;
name_tokens = G__15038;
continue;
} else {
...
var vec__15041 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__15041,(0),null);
var arity = cljs.core.nth.call(null,vec__15041,(1),null);
var vec__15044 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__15044,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__15044,(1),null);
var vec__15047 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__15047,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__15047,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__15047,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__15047,(3),null);
...
var vec__15053 = result;
var munged_ns = cljs.core.nth.call(null,vec__15053,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__15053,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__15053,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__15053,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__15053,(4),null);
var arity = cljs.core.nth.call(null,vec__15053,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__15057 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__15057,(0),null);
var args = cljs.core.nth.call(null,vec__15057,(1),null);
var vec__15060 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__15060,(0),null);
var name = cljs.core.nth.call(null,vec__15060,(1),null);
...
var G__15063 = (arity + (1));
var G__15064 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__15065){
var vec__15066 = p__15065;
var arity = cljs.core.nth.call(null,vec__15066,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__15066,(1),null);
...
return cljs.core.get.call(null,arities,p1__15069_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__15070_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__15073){
var vec__15074 = p__15073;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__15074,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq15071){
var G__15072 = cljs.core.first.call(null,seq15071);
var seq15071__$1 = cljs.core.next.call(null,seq15071);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15072,seq15071__$1);
});
...
var G__15080 = arg;
var G__15080__$1 = (((G__15080 instanceof cljs.core.Keyword))?G__15080.fqn:null);
switch (G__15080__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__15082__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__15082__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__15082__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__15082__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__15083 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__15083,(0),null);
var fn_name = cljs.core.nth.call(null,vec__15083,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__15083,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__15083,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__15083,(4),null);
var arity = cljs.core.nth.call(null,vec__15083,(5),null);
...
var o__14823__auto__ = f;
return (o__14823__auto__["getBasis"]).call(o__14823__auto__);
});
/**
...
}catch (e15087){var _e__14830__auto__ = e15087;
...
var G__15088 = (obj[cljs.core.first.call(null,path)]);
var G__15089 = cljs.core.rest.call(null,path);
obj = G__15088;
path = G__15089;
continue;
} else {
...
return (function (accum,p__15090){
var vec__15091 = p__15090;
var bit = cljs.core.nth.call(null,vec__15091,(0),null);
var protocol = cljs.core.nth.call(null,vec__15091,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__15094){
var vec__15095 = p__15094;
var ns = cljs.core.nth.call(null,vec__15095,(0),null);
var name = cljs.core.nth.call(null,vec__15095,(1),null);
var selector = cljs.core.nth.call(null,vec__15095,(2),null);
...
return (function (p__15099){
var vec__15100 = p__15099;
var munged_name = cljs.core.nth.call(null,vec__15100,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__15100,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__15100,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__15098_SHARP_){
return (obj[cljs.core.first.call(null,p1__15098_SHARP_)]);
});})(name,sorted_matches,vec__15100,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
