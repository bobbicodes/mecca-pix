...
var o19705 = temp__5455__auto__;
var temp__5455__auto____$1 = (o19705["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o19706 = temp__5455__auto____$1;
return (o19706["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__19525__auto__ = f;
return (o__19525__auto__["toString"]).call(o__19525__auto__);
} else {
return "";
}
}catch (e19707){var _ = e19707;
return "";
}});
...
try{var o__19525__auto___19709 = t;
(o__19525__auto___19709["cljs$lang$ctorPrWriter"]).call(o__19525__auto___19709,t,writer);
}catch (e19708){var __19710 = e19708;
}
...
var char_code = (function (){var o__19525__auto__ = (new String(char$));
return (o__19525__auto__["charCodeAt"]).call(o__19525__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__19525__auto__ = String;
return (o__19525__auto__["fromCharCode"]).call(o__19525__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__19711 = num_code;
switch (G__19711) {
case (1):
return (185);
...
var o__19525__auto__ = String;
return (o__19525__auto__["fromCharCode"]).call(o__19525__auto__,superscript_code);
});
/**
...
}catch (e19713){var _e__19532__auto__ = e19713;
return false;
}})())){
...
var vec__19714 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__19714,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o19717 = temp__5455__auto__;
var temp__5455__auto____$1 = (o19717["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o19718 = temp__5455__auto____$1;
return (o19718["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__19721){
var vec__19722 = p__19721;
var ns_detector = cljs.core.nth.call(null,vec__19722,(0),null);
...
var G__19728 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__19729 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__19728;
remaining_tokens = G__19729;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq19719){
var G__19720 = cljs.core.first.call(null,seq19719);
var seq19719__$1 = cljs.core.next.call(null,seq19719);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19720,seq19719__$1);
});
...
var vec__19733 = cljs.core.split_with.call(null,(function (p1__19732_SHARP_){
return cljs.core.not_EQ_.call(null,p1__19732_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__19733,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__19733,(1),null);
...
var vec__19736 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__19736,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__19736,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__19739 = cljs.core.rest.call(null,remaining_tokens);
var G__19740 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__19739;
name_tokens = G__19740;
continue;
} else {
...
var vec__19743 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__19743,(0),null);
var arity = cljs.core.nth.call(null,vec__19743,(1),null);
var vec__19746 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__19746,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__19746,(1),null);
var vec__19749 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__19749,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__19749,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__19749,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__19749,(3),null);
...
var vec__19755 = result;
var munged_ns = cljs.core.nth.call(null,vec__19755,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__19755,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__19755,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__19755,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__19755,(4),null);
var arity = cljs.core.nth.call(null,vec__19755,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__19759 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__19759,(0),null);
var args = cljs.core.nth.call(null,vec__19759,(1),null);
var vec__19762 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__19762,(0),null);
var name = cljs.core.nth.call(null,vec__19762,(1),null);
...
var G__19765 = (arity + (1));
var G__19766 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__19767){
var vec__19768 = p__19767;
var arity = cljs.core.nth.call(null,vec__19768,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__19768,(1),null);
...
return cljs.core.get.call(null,arities,p1__19771_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__19772_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___19779 = arguments.length;
var i__4532__auto___19780 = (0);
while(true){
if((i__4532__auto___19780 < len__4531__auto___19779)){
args__4534__auto__.push((arguments[i__4532__auto___19780]));

var G__19781 = (i__4532__auto___19780 + (1));
i__4532__auto___19780 = G__19781;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__19775){
var vec__19776 = p__19775;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__19776,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq19773){
var G__19774 = cljs.core.first.call(null,seq19773);
var seq19773__$1 = cljs.core.next.call(null,seq19773);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19774,seq19773__$1);
});
...
var map__19784 = options;
var map__19784__$1 = ((((!((map__19784 == null)))?(((((map__19784.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19784.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__19784):map__19784);
var include_ns_QMARK_ = cljs.core.get.call(null,map__19784__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__19784__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__19784__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__19784__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__19785 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__19785,(0),null);
var fn_name = cljs.core.nth.call(null,vec__19785,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__19785,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__19785,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__19785,(4),null);
var arity = cljs.core.nth.call(null,vec__19785,(5),null);
...
var o__19525__auto__ = f;
return (o__19525__auto__["getBasis"]).call(o__19525__auto__);
});
/**
...
}catch (e19789){var _e__19532__auto__ = e19789;
...
var G__19790 = (obj[cljs.core.first.call(null,path)]);
var G__19791 = cljs.core.rest.call(null,path);
obj = G__19790;
path = G__19791;
continue;
} else {
...
return (function (accum,p__19792){
var vec__19793 = p__19792;
var bit = cljs.core.nth.call(null,vec__19793,(0),null);
var protocol = cljs.core.nth.call(null,vec__19793,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__19796){
var vec__19797 = p__19796;
var ns = cljs.core.nth.call(null,vec__19797,(0),null);
var name = cljs.core.nth.call(null,vec__19797,(1),null);
var selector = cljs.core.nth.call(null,vec__19797,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__19802,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__19802,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__19802,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__19800_SHARP_){
return (obj[cljs.core.first.call(null,p1__19800_SHARP_)]);
});})(name,sorted_matches,vec__19802,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
