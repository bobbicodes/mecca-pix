...
var o15122 = temp__5455__auto__;
var temp__5455__auto____$1 = (o15122["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o15123 = temp__5455__auto____$1;
return (o15123["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__14942__auto__ = f;
return (o__14942__auto__["toString"]).call(o__14942__auto__);
} else {
return "";
}
}catch (e15124){var _ = e15124;
return "";
}});
...
try{var o__14942__auto___15126 = t;
(o__14942__auto___15126["cljs$lang$ctorPrWriter"]).call(o__14942__auto___15126,t,writer);
}catch (e15125){var __15127 = e15125;
}
...
var char_code = (function (){var o__14942__auto__ = (new String(char$));
return (o__14942__auto__["charCodeAt"]).call(o__14942__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__14942__auto__ = String;
return (o__14942__auto__["fromCharCode"]).call(o__14942__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__15128 = num_code;
switch (G__15128) {
case (1):
return (185);
...
var o__14942__auto__ = String;
return (o__14942__auto__["fromCharCode"]).call(o__14942__auto__,superscript_code);
});
/**
...
}catch (e15130){var _e__14949__auto__ = e15130;
return false;
}})())){
...
var vec__15131 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__15131,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o15134 = temp__5455__auto__;
var temp__5455__auto____$1 = (o15134["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o15135 = temp__5455__auto____$1;
return (o15135["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___15142 = arguments.length;
var i__4532__auto___15143 = (0);
while(true){
if((i__4532__auto___15143 < len__4531__auto___15142)){
args__4534__auto__.push((arguments[i__4532__auto___15143]));

var G__15144 = (i__4532__auto___15143 + (1));
i__4532__auto___15143 = G__15144;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__15138){
var vec__15139 = p__15138;
var ns_detector = cljs.core.nth.call(null,vec__15139,(0),null);
...
var G__15145 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__15146 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__15145;
remaining_tokens = G__15146;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq15136){
...
var vec__15150 = cljs.core.split_with.call(null,(function (p1__15149_SHARP_){
return cljs.core.not_EQ_.call(null,p1__15149_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__15150,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__15150,(1),null);
...
var vec__15153 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__15153,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__15153,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__15156 = cljs.core.rest.call(null,remaining_tokens);
var G__15157 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__15156;
name_tokens = G__15157;
continue;
} else {
...
var vec__15160 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__15160,(0),null);
var arity = cljs.core.nth.call(null,vec__15160,(1),null);
var vec__15163 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__15163,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__15163,(1),null);
var vec__15166 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__15166,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__15166,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__15166,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__15166,(3),null);
...
var vec__15172 = result;
var munged_ns = cljs.core.nth.call(null,vec__15172,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__15172,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__15172,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__15172,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__15172,(4),null);
var arity = cljs.core.nth.call(null,vec__15172,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__15176 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__15176,(0),null);
var args = cljs.core.nth.call(null,vec__15176,(1),null);
var vec__15179 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__15179,(0),null);
var name = cljs.core.nth.call(null,vec__15179,(1),null);
...
var G__15182 = (arity + (1));
var G__15183 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__15184){
var vec__15185 = p__15184;
var arity = cljs.core.nth.call(null,vec__15185,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__15185,(1),null);
...
return cljs.core.get.call(null,arities,p1__15188_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__15189_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___15196 = arguments.length;
var i__4532__auto___15197 = (0);
while(true){
if((i__4532__auto___15197 < len__4531__auto___15196)){
args__4534__auto__.push((arguments[i__4532__auto___15197]));

var G__15198 = (i__4532__auto___15197 + (1));
i__4532__auto___15197 = G__15198;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__15192){
var vec__15193 = p__15192;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__15193,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq15190){
var G__15191 = cljs.core.first.call(null,seq15190);
var seq15190__$1 = cljs.core.next.call(null,seq15190);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15191,seq15190__$1);
});
...
var G__15199 = arg;
var G__15199__$1 = (((G__15199 instanceof cljs.core.Keyword))?G__15199.fqn:null);
switch (G__15199__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__15201__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__15201__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__15201__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__15201__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__15202 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__15202,(0),null);
var fn_name = cljs.core.nth.call(null,vec__15202,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__15202,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__15202,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__15202,(4),null);
var arity = cljs.core.nth.call(null,vec__15202,(5),null);
...
var o__14942__auto__ = f;
return (o__14942__auto__["getBasis"]).call(o__14942__auto__);
});
/**
...
}catch (e15206){var _e__14949__auto__ = e15206;
...
var G__15207 = (obj[cljs.core.first.call(null,path)]);
var G__15208 = cljs.core.rest.call(null,path);
obj = G__15207;
path = G__15208;
continue;
} else {
...
return (function (accum,p__15209){
var vec__15210 = p__15209;
var bit = cljs.core.nth.call(null,vec__15210,(0),null);
var protocol = cljs.core.nth.call(null,vec__15210,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__15213){
var vec__15214 = p__15213;
var ns = cljs.core.nth.call(null,vec__15214,(0),null);
var name = cljs.core.nth.call(null,vec__15214,(1),null);
var selector = cljs.core.nth.call(null,vec__15214,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__15219,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__15219,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__15219,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__15217_SHARP_){
return (obj[cljs.core.first.call(null,p1__15217_SHARP_)]);
});})(name,sorted_matches,vec__15219,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
