...
var o15108 = temp__5455__auto__;
var temp__5455__auto____$1 = (o15108["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o15109 = temp__5455__auto____$1;
return (o15109["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__14928__auto__ = f;
return (o__14928__auto__["toString"]).call(o__14928__auto__);
} else {
return "";
}
}catch (e15110){var _ = e15110;
return "";
}});
...
try{var o__14928__auto___15112 = t;
(o__14928__auto___15112["cljs$lang$ctorPrWriter"]).call(o__14928__auto___15112,t,writer);
}catch (e15111){var __15113 = e15111;
}
...
var char_code = (function (){var o__14928__auto__ = (new String(char$));
return (o__14928__auto__["charCodeAt"]).call(o__14928__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__14928__auto__ = String;
return (o__14928__auto__["fromCharCode"]).call(o__14928__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__15114 = num_code;
switch (G__15114) {
case (1):
return (185);
...
var o__14928__auto__ = String;
return (o__14928__auto__["fromCharCode"]).call(o__14928__auto__,superscript_code);
});
/**
...
}catch (e15116){var _e__14935__auto__ = e15116;
return false;
}})())){
...
var vec__15117 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__15117,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o15120 = temp__5455__auto__;
var temp__5455__auto____$1 = (o15120["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o15121 = temp__5455__auto____$1;
return (o15121["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___15128 = arguments.length;
var i__4532__auto___15129 = (0);
while(true){
if((i__4532__auto___15129 < len__4531__auto___15128)){
args__4534__auto__.push((arguments[i__4532__auto___15129]));

var G__15130 = (i__4532__auto___15129 + (1));
i__4532__auto___15129 = G__15130;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__15124){
var vec__15125 = p__15124;
var ns_detector = cljs.core.nth.call(null,vec__15125,(0),null);
...
var G__15131 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__15132 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__15131;
remaining_tokens = G__15132;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq15122){
...
var vec__15136 = cljs.core.split_with.call(null,(function (p1__15135_SHARP_){
return cljs.core.not_EQ_.call(null,p1__15135_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__15136,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__15136,(1),null);
...
var vec__15139 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__15139,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__15139,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__15142 = cljs.core.rest.call(null,remaining_tokens);
var G__15143 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__15142;
name_tokens = G__15143;
continue;
} else {
...
var vec__15146 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__15146,(0),null);
var arity = cljs.core.nth.call(null,vec__15146,(1),null);
var vec__15149 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__15149,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__15149,(1),null);
var vec__15152 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__15152,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__15152,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__15152,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__15152,(3),null);
...
var vec__15158 = result;
var munged_ns = cljs.core.nth.call(null,vec__15158,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__15158,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__15158,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__15158,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__15158,(4),null);
var arity = cljs.core.nth.call(null,vec__15158,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__15162 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__15162,(0),null);
var args = cljs.core.nth.call(null,vec__15162,(1),null);
var vec__15165 = devtools.munging.break_and_demunge_name.call(null,munged_name);
...
var G__15168 = (arity + (1));
var G__15169 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__15170){
var vec__15171 = p__15170;
var arity = cljs.core.nth.call(null,vec__15171,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__15171,(1),null);
...
return cljs.core.get.call(null,arities,p1__15174_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__15175_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__15178){
var vec__15179 = p__15178;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__15179,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq15176){
var G__15177 = cljs.core.first.call(null,seq15176);
var seq15176__$1 = cljs.core.next.call(null,seq15176);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15177,seq15176__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__15187__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__15187__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__15187__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__15187__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__15188 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__15188,(0),null);
var fn_name = cljs.core.nth.call(null,vec__15188,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__15188,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__15188,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__15188,(4),null);
var arity = cljs.core.nth.call(null,vec__15188,(5),null);
...
var o__14928__auto__ = f;
return (o__14928__auto__["getBasis"]).call(o__14928__auto__);
});
/**
...
}catch (e15192){var _e__14935__auto__ = e15192;
...
var G__15193 = (obj[cljs.core.first.call(null,path)]);
var G__15194 = cljs.core.rest.call(null,path);
obj = G__15193;
path = G__15194;
continue;
} else {
...
return (function (accum,p__15195){
var vec__15196 = p__15195;
var bit = cljs.core.nth.call(null,vec__15196,(0),null);
var protocol = cljs.core.nth.call(null,vec__15196,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__15199){
var vec__15200 = p__15199;
var ns = cljs.core.nth.call(null,vec__15200,(0),null);
var name = cljs.core.nth.call(null,vec__15200,(1),null);
var selector = cljs.core.nth.call(null,vec__15200,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__15205,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__15205,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__15205,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__15203_SHARP_){
return (obj[cljs.core.first.call(null,p1__15203_SHARP_)]);
});})(name,sorted_matches,vec__15205,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
