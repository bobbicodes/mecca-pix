...
var o14991 = temp__5455__auto__;
var temp__5455__auto____$1 = (o14991["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o14992 = temp__5455__auto____$1;
return (o14992["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__14811__auto__ = f;
return (o__14811__auto__["toString"]).call(o__14811__auto__);
} else {
return "";
}
}catch (e14993){var _ = e14993;
return "";
}});
...
try{var o__14811__auto___14995 = t;
(o__14811__auto___14995["cljs$lang$ctorPrWriter"]).call(o__14811__auto___14995,t,writer);
}catch (e14994){var __14996 = e14994;
}
...
var char_code = (function (){var o__14811__auto__ = (new String(char$));
return (o__14811__auto__["charCodeAt"]).call(o__14811__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__14811__auto__ = String;
return (o__14811__auto__["fromCharCode"]).call(o__14811__auto__,subscript_code);
});
/**
...
var o__14811__auto__ = String;
return (o__14811__auto__["fromCharCode"]).call(o__14811__auto__,superscript_code);
});
/**
...
}catch (e14999){var _e__14818__auto__ = e14999;
return false;
}})())){
...
var vec__15000 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__15000,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o15003 = temp__5455__auto__;
var temp__5455__auto____$1 = (o15003["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o15004 = temp__5455__auto____$1;
return (o15004["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___15011 = arguments.length;
var i__4532__auto___15012 = (0);
while(true){
if((i__4532__auto___15012 < len__4531__auto___15011)){
args__4534__auto__.push((arguments[i__4532__auto___15012]));

var G__15013 = (i__4532__auto___15012 + (1));
i__4532__auto___15012 = G__15013;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__15007){
var vec__15008 = p__15007;
var ns_detector = cljs.core.nth.call(null,vec__15008,(0),null);
...
var G__15014 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__15015 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__15014;
remaining_tokens = G__15015;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq15005){
var G__15006 = cljs.core.first.call(null,seq15005);
var seq15005__$1 = cljs.core.next.call(null,seq15005);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15006,seq15005__$1);
});
...
var vec__15019 = cljs.core.split_with.call(null,(function (p1__15018_SHARP_){
return cljs.core.not_EQ_.call(null,p1__15018_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__15019,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__15019,(1),null);
...
var vec__15022 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__15022,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__15022,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__15025 = cljs.core.rest.call(null,remaining_tokens);
var G__15026 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__15025;
name_tokens = G__15026;
continue;
} else {
...
var vec__15029 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__15029,(0),null);
var arity = cljs.core.nth.call(null,vec__15029,(1),null);
var vec__15032 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__15032,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__15032,(1),null);
var vec__15035 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__15035,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__15035,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__15035,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__15035,(3),null);
...
var vec__15041 = result;
var munged_ns = cljs.core.nth.call(null,vec__15041,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__15041,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__15041,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__15041,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__15041,(4),null);
var arity = cljs.core.nth.call(null,vec__15041,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__15045 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__15045,(0),null);
var args = cljs.core.nth.call(null,vec__15045,(1),null);
var vec__15048 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__15048,(0),null);
var name = cljs.core.nth.call(null,vec__15048,(1),null);
...
var G__15051 = (arity + (1));
var G__15052 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__15053){
var vec__15054 = p__15053;
var arity = cljs.core.nth.call(null,vec__15054,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__15054,(1),null);
...
return (function (p1__15057_SHARP_){
return cljs.core.get.call(null,arities,p1__15057_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__15058_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__15061){
var vec__15062 = p__15061;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__15062,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq15059){
var G__15060 = cljs.core.first.call(null,seq15059);
var seq15059__$1 = cljs.core.next.call(null,seq15059);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15060,seq15059__$1);
});
...
var map__15070 = options;
var map__15070__$1 = ((((!((map__15070 == null)))?(((((map__15070.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15070.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15070):map__15070);
var include_ns_QMARK_ = cljs.core.get.call(null,map__15070__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__15070__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__15070__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__15070__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__15071 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__15071,(0),null);
var fn_name = cljs.core.nth.call(null,vec__15071,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__15071,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__15071,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__15071,(4),null);
var arity = cljs.core.nth.call(null,vec__15071,(5),null);
...
var o__14811__auto__ = f;
return (o__14811__auto__["getBasis"]).call(o__14811__auto__);
});
/**
...
}catch (e15075){var _e__14818__auto__ = e15075;
...
var G__15076 = (obj[cljs.core.first.call(null,path)]);
var G__15077 = cljs.core.rest.call(null,path);
obj = G__15076;
path = G__15077;
continue;
} else {
...
return (function (accum,p__15078){
var vec__15079 = p__15078;
var bit = cljs.core.nth.call(null,vec__15079,(0),null);
var protocol = cljs.core.nth.call(null,vec__15079,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__15082){
var vec__15083 = p__15082;
var ns = cljs.core.nth.call(null,vec__15083,(0),null);
var name = cljs.core.nth.call(null,vec__15083,(1),null);
var selector = cljs.core.nth.call(null,vec__15083,(2),null);
...
return (function (p__15087){
var vec__15088 = p__15087;
var munged_name = cljs.core.nth.call(null,vec__15088,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__15088,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__15088,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__15086_SHARP_){
return (obj[cljs.core.first.call(null,p1__15086_SHARP_)]);
});})(name,sorted_matches,vec__15088,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
