...
return cljs.core.assoc.call(null,G__14389,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__14389;
}
});
...
var len__4531__auto___14394 = arguments.length;
var i__4532__auto___14395 = (0);
while(true){
if((i__4532__auto___14395 < len__4531__auto___14394)){
args__4534__auto__.push((arguments[i__4532__auto___14395]));

var G__14396 = (i__4532__auto___14395 + (1));
i__4532__auto___14395 = G__14396;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq14391){
...
var file = cljs.core.get.call(null,map__14398__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__14398__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__14398__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__14398,map__14398__$1,file,line,column){
return (function (p1__14397_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__14397_SHARP_));
});})(map__14398,map__14398__$1,file,line,column))
...
var temp__5457__auto___14400 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___14400)){
var message_14401 = temp__5457__auto___14400;
cljs.core.println.call(null,message_14401);
} else {
}
...
var temp__5457__auto___14402 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___14402)){
var message_14403 = temp__5457__auto___14402;
cljs.core.println.call(null,message_14403);
} else {
}
...
var output_dir__$1 = (function (){var G__14404 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14404),"/"].join('');
} else {
return G__14404;
}
})();
...
var G__14406 = exception.stack;
var G__14406__$1 = (((G__14406 == null))?null:clojure.string.split_lines.call(null,G__14406));
var G__14406__$2 = (((G__14406__$1 == null))?null:cljs.core.get.call(null,G__14406__$1,depth));
if((G__14406__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__14406__$2);
}
} else {
...
var vec__14407 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__14407,(0),null);
var column = cljs.core.nth.call(null,vec__14407,(1),null);
var vec__14410 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__14410,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__14410,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__14410,(2),null);
...
var m__$1 = (function (){var G__14413 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__14413__$1 = (((G__14413 instanceof cljs.core.Keyword))?G__14413.fqn:null);
switch (G__14413__$1) {
case "fail":
...
var G__14417 = (function (){var G__14416 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__14416);
} else {
return G__14416;
}
})();
...
return cljs.core.vary_meta.call(null,G__14418,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__14422 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__14422,(0),null);
var types = vec__14422;
...
return cljs.core.map.call(null,(function (p__14425){
var vec__14426 = p__14425;
var ns = cljs.core.nth.call(null,vec__14426,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__14426,(1),null);
return ((function (vec__14426,ns,vars__$1){
return (function (){
...
var G__14429 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__14429,G__14429__$1,env,once_fixtures,each_fixtures,vec__14426,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__14429,G__14429__$1,env,once_fixtures,each_fixtures,vec__14426,ns,vars__$1){
return (function (){
var seq__14430 = cljs.core.seq.call(null,vars__$1);
var chunk__14431 = null;
var count__14432 = (0);
var i__14433 = (0);
while(true){
if((i__14433 < count__14432)){
var v = cljs.core._nth.call(null,chunk__14431,i__14433);
var temp__5457__auto___14435 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___14435)){
var t_14436 = temp__5457__auto___14435;
each_fixture_fn.call(null,((function (seq__14430,chunk__14431,count__14432,i__14433,t_14436,temp__5457__auto___14435,v,each_fixture_fn,G__14429,G__14429__$1,env,once_fixtures,each_fixtures,vec__14426,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14436)));
});})(seq__14430,chunk__14431,count__14432,i__14433,t_14436,temp__5457__auto___14435,v,each_fixture_fn,G__14429,G__14429__$1,env,once_fixtures,each_fixtures,vec__14426,ns,vars__$1))
);
} else {
}


var G__14437 = seq__14430;
var G__14438 = chunk__14431;
var G__14439 = count__14432;
var G__14440 = (i__14433 + (1));
seq__14430 = G__14437;
chunk__14431 = G__14438;
count__14432 = G__14439;
i__14433 = G__14440;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__14430);
if(temp__5457__auto__){
var seq__14430__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__14430__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__14430__$1);
var G__14441 = cljs.core.chunk_rest.call(null,seq__14430__$1);
var G__14442 = c__4351__auto__;
var G__14443 = cljs.core.count.call(null,c__4351__auto__);
var G__14444 = (0);
seq__14430 = G__14441;
chunk__14431 = G__14442;
count__14432 = G__14443;
i__14433 = G__14444;
continue;
} else {
var v = cljs.core.first.call(null,seq__14430__$1);
var temp__5457__auto___14445__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___14445__$1)){
var t_14446 = temp__5457__auto___14445__$1;
each_fixture_fn.call(null,((function (seq__14430,chunk__14431,count__14432,i__14433,t_14446,temp__5457__auto___14445__$1,v,seq__14430__$1,temp__5457__auto__,each_fixture_fn,G__14429,G__14429__$1,env,once_fixtures,each_fixtures,vec__14426,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14446)));
});})(seq__14430,chunk__14431,count__14432,i__14433,t_14446,temp__5457__auto___14445__$1,v,seq__14430__$1,temp__5457__auto__,each_fixture_fn,G__14429,G__14429__$1,env,once_fixtures,each_fixtures,vec__14426,ns,vars__$1))
);
} else {
}
...
});})(each_fixture_fn,G__14429,G__14429__$1,env,once_fixtures,each_fixtures,vec__14426,ns,vars__$1))
);
});})(each_fixture_fn,G__14429,G__14429__$1,env,once_fixtures,each_fixtures,vec__14426,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14429__$1)].join('')));

}
})());
});
;})(vec__14426,ns,vars__$1))
