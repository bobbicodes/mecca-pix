...
var G__19220 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__19220,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__19220;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq19222){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19223,G__19224,seq19222__$2);
});
...
var file = cljs.core.get.call(null,map__19229__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__19229__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__19229__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__19229,map__19229__$1,file,line,column){
return (function (p1__19228_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__19228_SHARP_));
});})(map__19229,map__19229__$1,file,line,column))
...
var temp__5457__auto___19231 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___19231)){
var message_19232 = temp__5457__auto___19231;
cljs.core.println.call(null,message_19232);
} else {
}
...
var temp__5457__auto___19233 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___19233)){
var message_19234 = temp__5457__auto___19233;
cljs.core.println.call(null,message_19234);
} else {
}
...
var output_dir__$1 = (function (){var G__19235 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__19235),"/"].join('');
} else {
return G__19235;
}
})();
...
var G__19237 = exception.stack;
var G__19237__$1 = (((G__19237 == null))?null:clojure.string.split_lines.call(null,G__19237));
var G__19237__$2 = (((G__19237__$1 == null))?null:cljs.core.get.call(null,G__19237__$1,depth));
if((G__19237__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__19237__$2);
}
} else {
...
var vec__19238 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__19238,(0),null);
var column = cljs.core.nth.call(null,vec__19238,(1),null);
var vec__19241 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__19241,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__19241,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__19241,(2),null);
...
var m__$1 = (function (){var G__19244 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__19248 = (function (){var G__19247 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__19247);
} else {
return G__19247;
}
})();
...
return cljs.core.vary_meta.call(null,G__19249,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__19253 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__19253,(0),null);
var types = vec__19253;
...
return cljs.core.map.call(null,(function (p__19256){
var vec__19257 = p__19256;
var ns = cljs.core.nth.call(null,vec__19257,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__19257,(1),null);
return ((function (vec__19257,ns,vars__$1){
return (function (){
...
var G__19260 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__19260__$1 = (((G__19260 instanceof cljs.core.Keyword))?G__19260.fqn:null);
switch (G__19260__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__19260,G__19260__$1,env,once_fixtures,each_fixtures,vec__19257,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__19260,G__19260__$1,env,once_fixtures,each_fixtures,vec__19257,ns,vars__$1){
return (function (){
var seq__19261 = cljs.core.seq.call(null,vars__$1);
var chunk__19262 = null;
var count__19263 = (0);
var i__19264 = (0);
while(true){
if((i__19264 < count__19263)){
var v = cljs.core._nth.call(null,chunk__19262,i__19264);
var temp__5457__auto___19266 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___19266)){
var t_19267 = temp__5457__auto___19266;
each_fixture_fn.call(null,((function (seq__19261,chunk__19262,count__19263,i__19264,t_19267,temp__5457__auto___19266,v,each_fixture_fn,G__19260,G__19260__$1,env,once_fixtures,each_fixtures,vec__19257,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_19267)));
});})(seq__19261,chunk__19262,count__19263,i__19264,t_19267,temp__5457__auto___19266,v,each_fixture_fn,G__19260,G__19260__$1,env,once_fixtures,each_fixtures,vec__19257,ns,vars__$1))
);
} else {
}


var G__19268 = seq__19261;
var G__19269 = chunk__19262;
var G__19270 = count__19263;
var G__19271 = (i__19264 + (1));
seq__19261 = G__19268;
chunk__19262 = G__19269;
count__19263 = G__19270;
i__19264 = G__19271;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__19261);
if(temp__5457__auto__){
var seq__19261__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__19261__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__19261__$1);
var G__19272 = cljs.core.chunk_rest.call(null,seq__19261__$1);
var G__19273 = c__4351__auto__;
var G__19274 = cljs.core.count.call(null,c__4351__auto__);
var G__19275 = (0);
seq__19261 = G__19272;
chunk__19262 = G__19273;
count__19263 = G__19274;
i__19264 = G__19275;
continue;
} else {
var v = cljs.core.first.call(null,seq__19261__$1);
var temp__5457__auto___19276__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___19276__$1)){
var t_19277 = temp__5457__auto___19276__$1;
each_fixture_fn.call(null,((function (seq__19261,chunk__19262,count__19263,i__19264,t_19277,temp__5457__auto___19276__$1,v,seq__19261__$1,temp__5457__auto__,each_fixture_fn,G__19260,G__19260__$1,env,once_fixtures,each_fixtures,vec__19257,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_19277)));
});})(seq__19261,chunk__19262,count__19263,i__19264,t_19277,temp__5457__auto___19276__$1,v,seq__19261__$1,temp__5457__auto__,each_fixture_fn,G__19260,G__19260__$1,env,once_fixtures,each_fixtures,vec__19257,ns,vars__$1))
);
} else {
}


var G__19278 = cljs.core.next.call(null,seq__19261__$1);
var G__19279 = null;
var G__19280 = (0);
var G__19281 = (0);
seq__19261 = G__19278;
chunk__19262 = G__19279;
count__19263 = G__19280;
i__19264 = G__19281;
continue;
}
} else {
...
});})(each_fixture_fn,G__19260,G__19260__$1,env,once_fixtures,each_fixtures,vec__19257,ns,vars__$1))
);
});})(each_fixture_fn,G__19260,G__19260__$1,env,once_fixtures,each_fixtures,vec__19257,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__19260__$1)].join('')));

}
})());
});
;})(vec__19257,ns,vars__$1))
