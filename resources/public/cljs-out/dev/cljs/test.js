...
var G__14225 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__14225,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__14225;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq14227){
var G__14228 = cljs.core.first.call(null,seq14227);
var seq14227__$1 = cljs.core.next.call(null,seq14227);
var G__14229 = cljs.core.first.call(null,seq14227__$1);
var seq14227__$2 = cljs.core.next.call(null,seq14227__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14228,G__14229,seq14227__$2);
});
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__14234,map__14234__$1,file,line,column){
return (function (p1__14233_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__14233_SHARP_));
});})(map__14234,map__14234__$1,file,line,column))
...
var temp__5457__auto___14236 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___14236)){
var message_14237 = temp__5457__auto___14236;
cljs.core.println.call(null,message_14237);
} else {
}
...
var temp__5457__auto___14238 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___14238)){
var message_14239 = temp__5457__auto___14238;
cljs.core.println.call(null,message_14239);
} else {
}
...
var output_dir__$1 = (function (){var G__14240 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14240),"/"].join('');
} else {
return G__14240;
}
})();
...
var G__14242 = exception.stack;
var G__14242__$1 = (((G__14242 == null))?null:clojure.string.split_lines.call(null,G__14242));
var G__14242__$2 = (((G__14242__$1 == null))?null:cljs.core.get.call(null,G__14242__$1,depth));
if((G__14242__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__14242__$2);
}
} else {
...
var vec__14243 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__14243,(0),null);
var column = cljs.core.nth.call(null,vec__14243,(1),null);
var vec__14246 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__14246,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__14246,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__14246,(2),null);
...
var m__$1 = (function (){var G__14249 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__14253 = (function (){var G__14252 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__14252);
} else {
return G__14252;
}
})();
...
return cljs.core.vary_meta.call(null,G__14254,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__14258 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__14258,(0),null);
var types = vec__14258;
...
return cljs.core.map.call(null,(function (p__14261){
var vec__14262 = p__14261;
var ns = cljs.core.nth.call(null,vec__14262,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__14262,(1),null);
return ((function (vec__14262,ns,vars__$1){
return (function (){
...
var G__14265 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__14265,G__14265__$1,env,once_fixtures,each_fixtures,vec__14262,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__14265,G__14265__$1,env,once_fixtures,each_fixtures,vec__14262,ns,vars__$1){
return (function (){
var seq__14266 = cljs.core.seq.call(null,vars__$1);
var chunk__14267 = null;
var count__14268 = (0);
var i__14269 = (0);
while(true){
if((i__14269 < count__14268)){
var v = cljs.core._nth.call(null,chunk__14267,i__14269);
var temp__5457__auto___14271 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___14271)){
var t_14272 = temp__5457__auto___14271;
each_fixture_fn.call(null,((function (seq__14266,chunk__14267,count__14268,i__14269,t_14272,temp__5457__auto___14271,v,each_fixture_fn,G__14265,G__14265__$1,env,once_fixtures,each_fixtures,vec__14262,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14272)));
});})(seq__14266,chunk__14267,count__14268,i__14269,t_14272,temp__5457__auto___14271,v,each_fixture_fn,G__14265,G__14265__$1,env,once_fixtures,each_fixtures,vec__14262,ns,vars__$1))
);
} else {
}


var G__14273 = seq__14266;
var G__14274 = chunk__14267;
var G__14275 = count__14268;
var G__14276 = (i__14269 + (1));
seq__14266 = G__14273;
chunk__14267 = G__14274;
count__14268 = G__14275;
i__14269 = G__14276;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__14266);
if(temp__5457__auto__){
var seq__14266__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__14266__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__14266__$1);
var G__14277 = cljs.core.chunk_rest.call(null,seq__14266__$1);
var G__14278 = c__4351__auto__;
var G__14279 = cljs.core.count.call(null,c__4351__auto__);
var G__14280 = (0);
seq__14266 = G__14277;
chunk__14267 = G__14278;
count__14268 = G__14279;
i__14269 = G__14280;
continue;
} else {
var v = cljs.core.first.call(null,seq__14266__$1);
var temp__5457__auto___14281__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___14281__$1)){
var t_14282 = temp__5457__auto___14281__$1;
each_fixture_fn.call(null,((function (seq__14266,chunk__14267,count__14268,i__14269,t_14282,temp__5457__auto___14281__$1,v,seq__14266__$1,temp__5457__auto__,each_fixture_fn,G__14265,G__14265__$1,env,once_fixtures,each_fixtures,vec__14262,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14282)));
});})(seq__14266,chunk__14267,count__14268,i__14269,t_14282,temp__5457__auto___14281__$1,v,seq__14266__$1,temp__5457__auto__,each_fixture_fn,G__14265,G__14265__$1,env,once_fixtures,each_fixtures,vec__14262,ns,vars__$1))
);
} else {
}


var G__14283 = cljs.core.next.call(null,seq__14266__$1);
var G__14284 = null;
var G__14285 = (0);
var G__14286 = (0);
seq__14266 = G__14283;
chunk__14267 = G__14284;
count__14268 = G__14285;
i__14269 = G__14286;
continue;
}
} else {
...
});})(each_fixture_fn,G__14265,G__14265__$1,env,once_fixtures,each_fixtures,vec__14262,ns,vars__$1))
);
});})(each_fixture_fn,G__14265,G__14265__$1,env,once_fixtures,each_fixtures,vec__14262,ns,vars__$1))
], null);
