...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__20329 = cljs.core.instance_QMARK_;
var expr__20330 = reactive_val;
if(cljs.core.truth_(pred__20329.call(null,reagent.ratom.RAtom,expr__20330))){
return "ra";
} else {
if(cljs.core.truth_(pred__20329.call(null,reagent.ratom.RCursor,expr__20330))){
return "rc";
} else {
if(cljs.core.truth_(pred__20329.call(null,reagent.ratom.Reaction,expr__20330))){
return "rx";
} else {
if(cljs.core.truth_(pred__20329.call(null,reagent.ratom.Track,expr__20330))){
return "tr";
} else {
return "other";
}
