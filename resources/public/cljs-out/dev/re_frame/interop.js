...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__11069 = cljs.core.instance_QMARK_;
var expr__11070 = reactive_val;
if(cljs.core.truth_((pred__11069.cljs$core$IFn$_invoke$arity$2 ? pred__11069.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__11070) : pred__11069.call(null,reagent.ratom.RAtom,expr__11070)))){
return "ra";
} else {
if(cljs.core.truth_((pred__11069.cljs$core$IFn$_invoke$arity$2 ? pred__11069.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__11070) : pred__11069.call(null,reagent.ratom.RCursor,expr__11070)))){
return "rc";
} else {
if(cljs.core.truth_((pred__11069.cljs$core$IFn$_invoke$arity$2 ? pred__11069.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__11070) : pred__11069.call(null,reagent.ratom.Reaction,expr__11070)))){
return "rx";
} else {
if(cljs.core.truth_((pred__11069.cljs$core$IFn$_invoke$arity$2 ? pred__11069.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__11070) : pred__11069.call(null,reagent.ratom.Track,expr__11070)))){
return "tr";
} else {
return "other";
}
