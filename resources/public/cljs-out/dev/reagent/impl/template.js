...
var G__10801 = o;
(G__10801[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__10803__i = 0, G__10803__a = new Array(arguments.length -  0);
while (G__10803__i < G__10803__a.length) {G__10803__a[G__10803__i] = arguments[G__10803__i + 0]; ++G__10803__i;}
  args = new cljs.core.IndexedSeq(G__10803__a,0,null);
} 
...
var G__10805 = o;
(G__10805[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__10810 = props;
var G__10810__$1 = ((((!((id == null))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10810,cljs.core.cst$kw$id,id):G__10810);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10810__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__10811){
...
var props = map__10812__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10812__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__10812,map__10812__$1,props,class$){
return (function (c){
...
});})(map__10812,map__10812__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__10814){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10815__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__10815,map__10815__$1,on_write){
return (function (){
...
});})(node_value,map__10815,map__10815__$1,on_write))
);
} else {
...
var G__10818 = jsprops;
(G__10818["defaultValue"] = value);

(G__10818["onChange"] = ((function (G__10818,v,value,on_change){
return (function (p1__10817_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__10817_SHARP_);
});})(G__10818,v,value,on_change))
);
...
var vec__10821 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10821,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10821,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10821,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___10825 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___10825 == null)){
} else {
var key_10826 = temp__5461__auto___10825;
(jsprops["key"] = key_10826);
}
...
var temp__5461__auto___10827 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___10827 == null)){
} else {
var key_10828 = temp__5461__auto___10827;
reagent.impl.template.oset(jsprops,"key",key_10828);
}
...
var G__10829 = reagent.impl.template.__GT_NativeWrapper();
(G__10829["name"] = c);
...
var G__10830 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__10830) : reagent.impl.template.as_element.call(null,G__10830));
} else {
...
var len__4531__auto___10835 = arguments.length;
var i__4532__auto___10836 = (0);
while(true){
if((i__4532__auto___10836 < len__4531__auto___10835)){
args__4534__auto__.push((arguments[i__4532__auto___10836]));

var G__10837 = (i__4532__auto___10836 + (1));
i__4532__auto___10836 = G__10837;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10833){
var G__10834 = cljs.core.first(seq10833);
var seq10833__$1 = cljs.core.next(seq10833);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10834,seq10833__$1);
});
...
break;
default:
var G__10840 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__10840;
continue;
...
var n__4408__auto___10842 = a.length;
var i_10843 = (0);
while(true){
if((i_10843 < n__4408__auto___10842)){
(a[i_10843] = reagent.impl.template.as_element((a[i_10843])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4408__auto___10845 = a.length;
var i_10846 = (0);
while(true){
if((i_10846 < n__4408__auto___10845)){
var val_10847 = (a[i_10846]);
if(((cljs.core.vector_QMARK_(val_10847)) && ((reagent.impl.template.key_from_vec(val_10847) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_10846] = reagent.impl.template.as_element(val_10847));
...
var ctx = ({});
var vec__10849 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10849,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10849,(1),null);
...
var G__10852 = (cljs.core.count(argv) - first_child);
switch (G__10852) {
case (0):
...
case (1):
var G__10853 = comp;
var G__10854 = jsprops;
var G__10855 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__10853,G__10854,G__10855) : reagent.impl.template.global$module$react.createElement.call(null,G__10853,G__10854,G__10855));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__10852){
