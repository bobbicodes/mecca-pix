...
var len__4531__auto___22144 = arguments.length;
var i__4532__auto___22145 = (0);
while(true){
if((i__4532__auto___22145 < len__4531__auto___22144)){
args__4534__auto__.push((arguments[i__4532__auto___22145]));

var G__22146 = (i__4532__auto___22145 + (1));
i__4532__auto___22145 = G__22146;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs_test_display.core.n.cljs$lang$applyTo = (function (seq22141){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22142,G__22143,seq22141__$2);
});
...
var vec__22147 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__22147,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__22147,(1),null);
var G__22150 = cljs.core.PersistentArrayMap.EMPTY;
var G__22150__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__22150,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22150);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__22150__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__22150__$1;
}
} else {
...
return (function() { 
var G__22154__delegate = function (klass,contents){
var vec__22151 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__22151,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__22151,(1),null);
...
var G__22154 = function (klass,var_args){
var contents = null;
...
while (G__22155__i < G__22155__a.length) {G__22155__a[G__22155__i] = arguments[G__22155__i + 1]; ++G__22155__i;}
  contents = new cljs.core.IndexedSeq(G__22155__a,0,null);
} 
return G__22154__delegate.call(this,klass,contents);};
G__22154.cljs$lang$maxFixedArity = 1;
G__22154.cljs$lang$applyTo = (function (arglist__22156){
var klass = cljs.core.first(arglist__22156);
var contents = cljs.core.rest(arglist__22156);
return G__22154__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__22160){
...
var ns = cljs.core.get.call(null,map__22161__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__22161__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__22163){
...
var actual = cljs.core.get.call(null,map__22164__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__22164__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__22166){
var map__22167 = p__22166;
var map__22167__$1 = ((((!((map__22167 == null)))?(((((map__22167.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22167.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__22167):map__22167);
var expected = cljs.core.get.call(null,map__22167__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__22167__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
return cljs.core.cons.call(null,new_current_node,p1__22169_SHARP_);
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__22171 = cljs_test_display.core.current_var_info.call(null);
...
var info = map__22171__$1;
var name = cljs.core.get.call(null,map__22171__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__22171__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__22171__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),((function (curr_node,map__22171,map__22171__$1,info,name,line,file,node){
return (function (p1__22170_SHARP_){
return cljs.core.cons.call(null,node,p1__22170_SHARP_);
});})(curr_node,map__22171,map__22171__$1,info,name,line,file,node))
);

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__22173){
var map__22174 = p__22173;
var map__22174__$1 = ((((!((map__22174 == null)))?(((((map__22174.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22174.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__22174):map__22174);
var m = map__22174__$1;
var fail = cljs.core.get.call(null,map__22174__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__22174__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__22174__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__22174__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5457__auto___22176 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___22176)){
var message_22177 = temp__5457__auto___22176;
cljs.core.println.call(null,message_22177);
} else {
}
...
var temp__5457__auto___22178 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___22178)){
var message_22179 = temp__5457__auto___22178;
cljs.core.println.call(null,message_22179);
} else {
}
