...
ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4205__auto__,k11018,else__4206__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k11018,else__4206__auto__);
...
ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__11017){
var self__ = this;
var G__11017__$1 = this;
return (new cljs.core.RecordIter((0),G__11017__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$status,cljs.core.cst$kw$body,cljs.core.cst$kw$status_DASH_text,cljs.core.cst$kw$headers,cljs.core.cst$kw$was_DASH_aborted], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
var h__4061__auto____$1 = (function (){var fexpr__11023 = ((function (h__4061__auto__,this__4199__auto____$1){
return (function (coll__4200__auto__){
return (-473222333 ^ cljs.core.hash_unordered_coll(coll__4200__auto__));
});})(h__4061__auto__,this__4199__auto____$1))
;
return fexpr__11023(this__4199__auto____$1);
})();
...
ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this11019,other11020){
var self__ = this;
var this11019__$1 = this;
return ((!((other11020 == null))) && ((this11019__$1.constructor === other11020.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this11019__$1.status,other11020.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this11019__$1.body,other11020.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this11019__$1.status_text,other11020.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this11019__$1.headers,other11020.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this11019__$1.was_aborted,other11020.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this11019__$1.__extmap,other11020.__extmap)));
});
...
ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4210__auto__,k__4211__auto__,G__11017){
var self__ = this;
var this__4210__auto____$1 = this;
var pred__11024 = cljs.core.keyword_identical_QMARK_;
var expr__11025 = k__4211__auto__;
if(cljs.core.truth_((function (){var G__11027 = cljs.core.cst$kw$status;
var G__11028 = expr__11025;
return (pred__11024.cljs$core$IFn$_invoke$arity$2 ? pred__11024.cljs$core$IFn$_invoke$arity$2(G__11027,G__11028) : pred__11024.call(null,G__11027,G__11028));
})())){
return (new ajax.protocols.Response(G__11017,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__11029 = cljs.core.cst$kw$body;
var G__11030 = expr__11025;
return (pred__11024.cljs$core$IFn$_invoke$arity$2 ? pred__11024.cljs$core$IFn$_invoke$arity$2(G__11029,G__11030) : pred__11024.call(null,G__11029,G__11030));
})())){
return (new ajax.protocols.Response(self__.status,G__11017,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__11031 = cljs.core.cst$kw$status_DASH_text;
var G__11032 = expr__11025;
return (pred__11024.cljs$core$IFn$_invoke$arity$2 ? pred__11024.cljs$core$IFn$_invoke$arity$2(G__11031,G__11032) : pred__11024.call(null,G__11031,G__11032));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,G__11017,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__11033 = cljs.core.cst$kw$headers;
var G__11034 = expr__11025;
return (pred__11024.cljs$core$IFn$_invoke$arity$2 ? pred__11024.cljs$core$IFn$_invoke$arity$2(G__11033,G__11034) : pred__11024.call(null,G__11033,G__11034));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__11017,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__11035 = cljs.core.cst$kw$was_DASH_aborted;
var G__11036 = expr__11025;
return (pred__11024.cljs$core$IFn$_invoke$arity$2 ? pred__11024.cljs$core$IFn$_invoke$arity$2(G__11035,G__11036) : pred__11024.call(null,G__11035,G__11036));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__11017,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4211__auto__,G__11017),null));
}
}
}
}
...
ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4202__auto__,G__11017){
var self__ = this;
var this__4202__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__11017,self__.__extmap,self__.__hash));
});
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__11021){
var extmap__4236__auto__ = (function (){var G__11037 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__11021,cljs.core.cst$kw$status,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$body,cljs.core.cst$kw$status_DASH_text,cljs.core.cst$kw$headers,cljs.core.cst$kw$was_DASH_aborted], 0));
if(cljs.core.record_QMARK_(G__11021)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__11037);
} else {
return G__11037;
}
})();
return (new ajax.protocols.Response(cljs.core.cst$kw$status.cljs$core$IFn$_invoke$arity$1(G__11021),cljs.core.cst$kw$body.cljs$core$IFn$_invoke$arity$1(G__11021),cljs.core.cst$kw$status_DASH_text.cljs$core$IFn$_invoke$arity$1(G__11021),cljs.core.cst$kw$headers.cljs$core$IFn$_invoke$arity$1(G__11021),cljs.core.cst$kw$was_DASH_aborted.cljs$core$IFn$_invoke$arity$1(G__11021),null,cljs.core.not_empty(extmap__4236__auto__),null));
});
