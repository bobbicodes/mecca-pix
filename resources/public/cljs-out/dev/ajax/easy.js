...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__11710 = cljs.core.second(format);
var G__11711 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__11710,G__11711) : ajax.easy.keyword_response_format_element.call(null,G__11710,G__11711));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__11714_SHARP_){
return ajax.easy.keyword_response_format_element(p1__11714_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__11715){
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11716__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11716__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11716__$1,cljs.core.cst$kw$finally);
...
return ((function (h,e,map__11716,map__11716__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__11718){
var vec__11719 = p__11718;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11719,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11719,(1),null);
var fexpr__11722_11723 = (cljs.core.truth_(ok)?h:e);
(fexpr__11722_11723.cljs$core$IFn$_invoke$arity$1 ? fexpr__11722_11723.cljs$core$IFn$_invoke$arity$1(result) : fexpr__11722_11723.call(null,result));
...
;})(h,e,map__11716,map__11716__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__11724){
var map__11725 = p__11724;
var map__11725__$1 = ((((!((map__11725 == null)))?(((((map__11725.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11725.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__11725):map__11725);
var opts = map__11725__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11725__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11725__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11725__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11725__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11725__$1,cljs.core.cst$kw$body);
