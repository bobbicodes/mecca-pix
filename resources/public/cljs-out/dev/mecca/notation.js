...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$path,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$transform,["translate(",cljs.core.str.cljs$core$IFn$_invoke$arity$1((0.3 + ((24) * (n - (1))))),",",cljs.core.str.cljs$core$IFn$_invoke$arity$1(6.3),")"].join(''),cljs.core.cst$kw$d,(function (){var G__20264 = n;
switch (G__20264) {
case (0):
...
mecca.notation.drum_hit = (function mecca$notation$drum_hit(duration,p__20266){
var vec__20267 = p__20266;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20267,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20267,(1),null);
var mouseover_QMARK_ = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false);
return ((function (mouseover_QMARK_,vec__20267,x,y){
return (function (color,p__20270){
var vec__20271 = p__20270;
var x__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20271,(0),null);
var y__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20271,(1),null);
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$on_DASH_mouse_DASH_over,((function (vec__20271,x__$1,y__$1,mouseover_QMARK_,vec__20267,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,true);
});})(vec__20271,x__$1,y__$1,mouseover_QMARK_,vec__20267,x,y))
,cljs.core.cst$kw$on_DASH_mouse_DASH_out,((function (vec__20271,x__$1,y__$1,mouseover_QMARK_,vec__20267,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,false);
});})(vec__20271,x__$1,y__$1,mouseover_QMARK_,vec__20267,x,y))
,cljs.core.cst$kw$on_DASH_click,((function (vec__20271,x__$1,y__$1,mouseover_QMARK_,vec__20267,x,y){
return (function (){
var G__20274 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$remove_DASH_note,x__$1,y__$1], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__20274) : re_frame.core.dispatch.call(null,G__20274));
});})(vec__20271,x__$1,y__$1,mouseover_QMARK_,vec__20267,x,y))
...
;})(mouseover_QMARK_,vec__20267,x,y))
});
mecca.notation.ledger_line = (function mecca$notation$ledger_line(p__20275){
...
mecca.notation.note = (function mecca$notation$note(value,p__20279){
var vec__20280 = p__20279;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20280,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20280,(1),null);
var mouseover_QMARK_ = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false);
return ((function (mouseover_QMARK_,vec__20280,x,y){
return (function (value__$1,p__20283){
var vec__20284 = p__20283;
var x__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20284,(0),null);
var y__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20284,(1),null);
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$on_DASH_mouse_DASH_over,((function (vec__20284,x__$1,y__$1,mouseover_QMARK_,vec__20280,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,true);
});})(vec__20284,x__$1,y__$1,mouseover_QMARK_,vec__20280,x,y))
,cljs.core.cst$kw$on_DASH_mouse_DASH_out,((function (vec__20284,x__$1,y__$1,mouseover_QMARK_,vec__20280,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,false);
});})(vec__20284,x__$1,y__$1,mouseover_QMARK_,vec__20280,x,y))
,cljs.core.cst$kw$on_DASH_click,((function (vec__20284,x__$1,y__$1,mouseover_QMARK_,vec__20280,x,y){
return (function (){
var G__20287 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$remove_DASH_note,x__$1,y__$1], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__20287) : re_frame.core.dispatch.call(null,G__20287));
});})(vec__20284,x__$1,y__$1,mouseover_QMARK_,vec__20280,x,y))
...
;})(mouseover_QMARK_,vec__20280,x,y))
});
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g_SHARP_lines,cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4324__auto__ = (function mecca$notation$staff_lines_$_iter__20288(s__20289){
return (new cljs.core.LazySeq(null,(function (){
var s__20289__$1 = s__20289;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__20289__$1);
if(temp__5457__auto__){
var s__20289__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__20289__$2)){
var c__4322__auto__ = cljs.core.chunk_first(s__20289__$2);
var size__4323__auto__ = cljs.core.count(c__4322__auto__);
var b__20291 = cljs.core.chunk_buffer(size__4323__auto__);
if((function (){var i__20290 = (0);
while(true){
if((i__20290 < size__4323__auto__)){
var y = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4322__auto__,i__20290);
cljs.core.chunk_append(b__20291,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$line,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$stroke_DASH_dasharray,cljs.core.cst$kw$stroke,cljs.core.cst$kw$stroke_DASH_linejoin,cljs.core.cst$kw$y1,cljs.core.cst$kw$stroke_DASH_linecap,cljs.core.cst$kw$stroke_DASH_width,cljs.core.cst$kw$x1,cljs.core.cst$kw$y2,cljs.core.cst$kw$x2,cljs.core.cst$kw$visibility],[((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(30))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(18)))))?0.25:null),"black","bevel",y,"butt",((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(30))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(18)))))?0.06:0.15),(1),y,(63),(((((y > (7))) && (cljs.core.even_QMARK_(y)) && ((y < (42)))))?"visible":"hidden")])], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,y], null)));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__20291),mecca$notation$staff_lines_$_iter__20288(cljs.core.chunk_rest(s__20289__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__20291),null);
}
} else {
var y = cljs.core.first(s__20289__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$line,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$stroke_DASH_dasharray,cljs.core.cst$kw$stroke,cljs.core.cst$kw$stroke_DASH_linejoin,cljs.core.cst$kw$y1,cljs.core.cst$kw$stroke_DASH_linecap,cljs.core.cst$kw$stroke_DASH_width,cljs.core.cst$kw$x1,cljs.core.cst$kw$y2,cljs.core.cst$kw$x2,cljs.core.cst$kw$visibility],[((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(30))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(18)))))?0.25:null),"black","bevel",y,"butt",((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(30))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(18)))))?0.06:0.15),(1),y,(63),(((((y > (7))) && (cljs.core.even_QMARK_(y)) && ((y < (42)))))?"visible":"hidden")])], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,y], null)),mecca$notation$staff_lines_$_iter__20288(cljs.core.rest(s__20289__$2)));
}
} else {
return null;
}
