...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([attrs,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$transform,["scale(",cljs.core.str.cljs$core$IFn$_invoke$arity$1(scale),") translate(",cljs.core.str.cljs$core$IFn$_invoke$arity$1(x),",",cljs.core.str.cljs$core$IFn$_invoke$arity$1(y),")"].join('')], null)], 0))], null),(function (){var iter__4324__auto__ = (function mecca$transport$iter__18715(s__18716){
return (new cljs.core.LazySeq(null,(function (){
var s__18716__$1 = s__18716;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__18716__$1);
if(temp__5457__auto__){
var s__18716__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__18716__$2)){
var c__4322__auto__ = cljs.core.chunk_first(s__18716__$2);
var size__4323__auto__ = cljs.core.count(c__4322__auto__);
var b__18718 = cljs.core.chunk_buffer(size__4323__auto__);
if((function (){var i__18717 = (0);
while(true){
if((i__18717 < size__4323__auto__)){
var vec__18719 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4322__auto__,i__18717);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18719,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18719,(1),null);
cljs.core.chunk_append(b__18718,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$path,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$stroke,color,cljs.core.cst$kw$d,path], null)], null));

var G__18726 = (i__18717 + (1));
i__18717 = G__18726;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__18718),mecca$transport$iter__18715(cljs.core.chunk_rest(s__18716__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__18718),null);
}
} else {
var vec__18722 = cljs.core.first(s__18716__$2);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18722,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18722,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$path,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$stroke,color,cljs.core.cst$kw$d,path], null)], null),mecca$transport$iter__18715(cljs.core.rest(s__18716__$2)));
}
} else {
return null;
}
...
var G__18727 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$inc_DASH_tempo], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__18727) : re_frame.core.dispatch.call(null,G__18727));
}),(1),x,"all","hidden",(scale * (12))])], null);
});
mecca.transport.tempo_down = (function mecca$transport$tempo_down(x,y,scale){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$rect,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$y,cljs.core.cst$kw$stroke,cljs.core.cst$kw$width,cljs.core.cst$kw$on_DASH_click,cljs.core.cst$kw$stroke_DASH_width,cljs.core.cst$kw$x,cljs.core.cst$kw$pointer_DASH_events,cljs.core.cst$kw$visibility,cljs.core.cst$kw$height],[y,"black",(scale * (12)),(function (){
var G__18728 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$dec_DASH_tempo], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__18728) : re_frame.core.dispatch.call(null,G__18728));
}),(1),x,"all","hidden",(scale * (12))])], null);
});
...
var G__18729_18731 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$stop], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__18729_18731) : re_frame.core.dispatch.call(null,G__18729_18731));

return mecca.music.play_sample((17),(63));
})], null),(cljs.core.truth_(cljs.core.deref((function (){var G__18730 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$playing_QMARK_], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__18730) : re_frame.core.subscribe.call(null,G__18730));
...
if(cljs.core.truth_(cljs.core.deref((function (){var G__18732 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$playing_QMARK_], null);
...
return mecca.transport.svg_paths.cljs$core$IFn$_invoke$arity$5(new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$on_DASH_click,(function (){
var G__18733_18735 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pause], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__18733_18735) : re_frame.core.dispatch.call(null,G__18733_18735));
...
return mecca.transport.svg_paths.cljs$core$IFn$_invoke$arity$5(new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$on_DASH_click,(function (){
var G__18734_18736 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$play_DASH_on], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__18734_18736) : re_frame.core.dispatch.call(null,G__18734_18736));
