...
var file = (function (){var G__12595 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$base64], null);
...
return ["<svg xmlns=\"http://www.w3.org/2000/svg\" shape-rendering=\"crispEdges\" viewBox=\"0 -0.5 ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(width)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(height),"\"><g>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,(function (){var iter__4324__auto__ = (function mecca$view$edn__GT_xml_$_iter__12596(s__12597){
return (new cljs.core.LazySeq(null,(function (){
var s__12597__$1 = s__12597;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__12597__$1);
if(temp__5457__auto__){
var s__12597__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__12597__$2)){
var c__4322__auto__ = cljs.core.chunk_first(s__12597__$2);
var size__4323__auto__ = cljs.core.count(c__4322__auto__);
var b__12599 = cljs.core.chunk_buffer(size__4323__auto__);
if((function (){var i__12598 = (0);
while(true){
if((i__12598 < size__4323__auto__)){
var vec__12600 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4322__auto__,i__12598);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12600,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12600,(1),null);
cljs.core.chunk_append(b__12599,["<path stroke=\"",cljs.core.str.cljs$core$IFn$_invoke$arity$1(color),"\" ","d=\"",cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),"\"></path>\n"].join(''));

var G__12606 = (i__12598 + (1));
i__12598 = G__12606;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__12599),mecca$view$edn__GT_xml_$_iter__12596(cljs.core.chunk_rest(s__12597__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__12599),null);
}
} else {
var vec__12603 = cljs.core.first(s__12597__$2);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12603,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12603,(1),null);
return cljs.core.cons(["<path stroke=\"",cljs.core.str.cljs$core$IFn$_invoke$arity$1(color),"\" ","d=\"",cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),"\"></path>\n"].join(''),mecca$view$edn__GT_xml_$_iter__12596(cljs.core.rest(s__12597__$2)));
}
} else {
return null;
}
...
var img = (function (){var G__12607 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$img], null);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [mecca.view.import_image], null),(function (){var temp__5457__auto__ = cljs.core.deref((function (){var G__12608 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$img], null);
...
return (function mecca$view$mecca_$_iter__12609(s__12610){
return (new cljs.core.LazySeq(null,((function (img,temp__5457__auto__){
return (function (){
var s__12610__$1 = s__12610;
while(true){
var temp__5457__auto____$1 = cljs.core.seq(s__12610__$1);
if(temp__5457__auto____$1){
var s__12610__$2 = temp__5457__auto____$1;
...
var vec__12613 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4322__auto__,i__12611);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__12612),mecca$view$mecca_$_iter__12609(cljs.core.chunk_rest(s__12610__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__12612),null);
}
} else {
var vec__12616 = cljs.core.first(s__12610__$2);
