...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g,(function (){var iter__4324__auto__ = (function mecca$castle$castle_arch_$_iter__20353(s__20354){
return (new cljs.core.LazySeq(null,(function (){
var s__20354__$1 = s__20354;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__20354__$1);
if(temp__5457__auto__){
var s__20354__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__20354__$2)){
var c__4322__auto__ = cljs.core.chunk_first(s__20354__$2);
var size__4323__auto__ = cljs.core.count(c__4322__auto__);
var b__20356 = cljs.core.chunk_buffer(size__4323__auto__);
if((function (){var i__20355 = (0);
while(true){
if((i__20355 < size__4323__auto__)){
var vec__20357 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4322__auto__,i__20355);
var dy = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20357,(0),null);
var dx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20357,(1),null);
cljs.core.chunk_append(b__20356,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$line,new cljs.core.PersistentArrayMap(null, 6, [cljs.core.cst$kw$x1,(x + ((40) - dx)),cljs.core.cst$kw$x2,((x + (40)) + dx),cljs.core.cst$kw$y1,(48.5 + dy),cljs.core.cst$kw$y2,(48.5 + dy),cljs.core.cst$kw$stroke,"black",cljs.core.cst$kw$stroke_DASH_width,2.1], null)], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dy,dx], null)], null)));

var G__20363 = (i__20355 + (1));
i__20355 = G__20363;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__20356),mecca$castle$castle_arch_$_iter__20353(cljs.core.chunk_rest(s__20354__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__20356),null);
}
} else {
var vec__20360 = cljs.core.first(s__20354__$2);
var dy = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20360,(0),null);
var dx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20360,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$line,new cljs.core.PersistentArrayMap(null, 6, [cljs.core.cst$kw$x1,(x + ((40) - dx)),cljs.core.cst$kw$x2,((x + (40)) + dx),cljs.core.cst$kw$y1,(48.5 + dy),cljs.core.cst$kw$y2,(48.5 + dy),cljs.core.cst$kw$stroke,"black",cljs.core.cst$kw$stroke_DASH_width,2.1], null)], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dy,dx], null)], null)),mecca$castle$castle_arch_$_iter__20353(cljs.core.rest(s__20354__$2)));
}
} else {
return null;
}
